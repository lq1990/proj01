			  ...
			  <div class="panel-body">
				<form id="userForm" role="form">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="rolename" value="${role.rolename }" placeholder="请输入角色名称">
				  </div>
	...
	<script src="${APP_PATH }/layer/layer.js"></script>
        <script type="text/javascript">
            $(function () {
			    ...
			    // 在修改user数据时，点击reset时，重置到未修改前的数据
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	if (rolename == '') {
						layer.msg("角色名称不能为空，请输入！", {time: 2000, icon: 5, shift:5}, function(){
			    	...
			    	$.ajax({
			    		...
			    		success: function(result){
			    			...
			    			if (result.success) {
								layer.msg("修改成功！",{time:800, icon:6, shift:5},function(){
									window.location.href="${APP_PATH}/role/index";
								});
								
								
							}else {
								layer.msg("修改失败，请重新操作！",{time:2000, icon:5, shift:5},function(){
