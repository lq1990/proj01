			  ...
			  <div class="panel-body">
				...
				<input type="hidden" name="userid" value="${user.id }" />
				  <div class="form-group">
					...
					<select name="unassignroleids" id="leftList" class="form-control" multiple size="10" style="width:230px;overflow-y:auto;">
                        <!-- form中有name属性的标签会被query接收 -->
				  ...
				  <div class="form-group" style="margin-left:40px;">
					...
					<select name="assignroleids" id="rightList" class="form-control" multiple size="10" style="width:230px;overflow-y:auto;">
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#left2RightBtn").click(function(){
			    	...
			    	if (opts.length == 0) {
						layer.msg("请选择需要分配的角色", {time: 2000, icon:5, shift:5}, function(){
						});
					} else {
						// 把元素放到右边
			    ...
			    $("#right2LeftBtn").click(function(){
			    	...
			    	if (opts.length == 0) {
						layer.msg("请选择需要取消分配的角色", {time: 2000, icon:5, shift:5}, function(){
						});
					} else {
						// 把元素放到右边
						$.ajax({
							...
							success: function(result) {
								if (result.success) {
									...
									layer.msg("取消分配角色成功", {time:1000, icon:6, shift:5}, function(){
										
									});
								} else {
									layer.msg("取消分配角色失败", {time:1000, icon:5, shift:5}, function(){
