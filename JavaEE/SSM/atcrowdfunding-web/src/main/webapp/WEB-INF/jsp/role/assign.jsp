							...
							<ul style="margin-top: 10px;">
								<li style="height: 30px;"><a href="${APP_PATH }/user/index"
									style="color: ;"><i class="glyphicon glyphicon-user"></i>
										用户维护</a></li>
								<li style="height: 30px;"><a href="${APP_PATH }/role/index" style="color:red;"><i
										class="glyphicon glyphicon-king"></i> 角色维护</a></li>
								<li style="height: 30px;"><a
									href="${APP_PATH }/permission/index" style=""><i
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<button class="btn btn-success" onclick="doAssign()">刷新许可</button><br/>
						<br/>
	...
	<script type="text/javascript">
		$(function() {
			...
			var setting = {
				      ...
				      async: {
				    	  enable: true,
				    	  url: "${APP_PATH}/permission/loadAssignData?roleid=${param.id}", // 点击按钮时，url param中有id信息
		...
		function doAssign() {
			...
			if (nodes.length == 0) {
				layer.msg("请选择需要分配的许可信息", {time:2000, icon:5, shift:5}, function() {
				});
			} else {
				// 拼接字符串
				...
				$.ajax({
					...
					success: function(result) {
						if (result.success) {
							layer.msg("分配许可信息成功", {time:2000, icon:6, shift:5}, function() {
							});
						} else {
