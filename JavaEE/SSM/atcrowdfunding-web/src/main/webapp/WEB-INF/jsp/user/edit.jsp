        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	if (loginacct == '') {
						layer.msg("登录账户不能为空，请输入！", {time: 2000, icon: 5, shift:5}, function(){
			    	...
			    	$.ajax({
			    		...
			    		success: function(result){
			    			...
			    			if (result.success) {
								layer.msg("用户信息修改成功！",{time:800, icon:6, shift:5},function(){
									window.location.href="${APP_PATH}/user/index";
								});
								
								
							}else {
								layer.msg("用户信息修改失败，请重新操作！",{time:2000, icon:5, shift:5},function(){
