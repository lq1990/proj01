			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input value="${permission.name }" type="text" class="form-control" id="permissionname" placeholder="请输入许可名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">链接地址</label>
					<input value="${permission.url }" type="text" class="form-control" id="url" placeholder="请输入链接地址">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	var pname = $("#permissionname").val();
			    	if (pname == '') {
						layer.msg("许可名称不能为空，请输入！", {time: 2000, icon: 5, shift:5}, function(){
			    	...
			    	$.ajax({
			    		...
			    		success: function(result){
			    			...
			    			if (result.success) {
								layer.msg("许可信息修改成功！",{time:800, icon:6, shift:5},function(){
									window.location.href="${APP_PATH}/permission/index";
								});
								
								
							}else {
								layer.msg("许可信息修改失败，请重新操作！",{time:2000, icon:5, shift:5},function(){
